...
public class PeliculaController implements Initializable {
	...
	private void select() {
		if (!idField.getText().isBlank())
			showById();
		else if (!directorField.getText().isBlank())
			showByDirector();
		else
			showAll();
	}
	...
	@FXML
	private void insert() {
		if (!tituloField.getText().isBlank() && !directorField.getText().isBlank() && !edadField.getText().isBlank()
				&& !generoField.getText().isBlank() && !caratulaField.getText().isBlank()) {
	...
	@FXML
	private void update() {
		if (!idField.getText().isBlank() && !tituloField.getText().isBlank() && !directorField.getText().isBlank()
				&& !edadField.getText().isBlank() && !generoField.getText().isBlank()
	...
	private void showPeliculas(List<Pelicula> datos) {
		...
		tablaView.getColumns().addAll(columnaId, columnaTitulo, columnaDirector, columnaEdad, columnaGenero,
				columnaCaratula);
